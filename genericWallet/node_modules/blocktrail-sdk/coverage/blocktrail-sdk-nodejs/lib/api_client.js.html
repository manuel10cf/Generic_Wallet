...
<html lang="en">
<head>
    <title>Code coverage report for blocktrail-sdk-nodejs/lib/api_client.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">blocktrail-sdk-nodejs/lib</a> api_client.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.53% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>512/628</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">67.41% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>213/316</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.13% </span>
        <span class="quiet">Functions</span>
        <span class='fraction'>123/138</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.38% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>507/623</span>
      </div>
    </div>
  </div>
...
1927
1928
1929</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
    self.bitcoinCash = options.network &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.network === "BCC";</span>
    self.feeSanityCheck = typeof options.feeSanityCheck !== "undefined" ? <span class="branch-0 cbranch-no" title="branch not covered" >options.feeSanityCheck </span>: true;
...
APIClient.initRestClient = function(options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (process.env.BLOCKTRAIL_SDK_API_ENDPOINT) {
<span class="cstat-no" title="statement not covered" >        options.host = process.env.BLOCKTRAIL_SDK_API_ENDPOINT;</span>
    }
&nbsp;
    // trim off leading https?://
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.host &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.host.indexOf("https://") === 0)</span> {
<span class="cstat-no" title="statement not covered" >        options.https = true;</span>
<span class="cstat-no" title="statement not covered" >        options.host = options.host.substr(8);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (options.host &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.host.indexOf("http://") === 0)</span> {
<span class="cstat-no" title="statement not covered" >        options.https = false;</span>
<span class="cstat-no" title="statement not covered" >        options.host = options.host.substr(7);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof options.https === "undefined") {
        options.https = true;
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.host) {
        options.host = 'api.blocktrail.com';
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.port) {
        options.port = options.https ? 443 : <span class="branch-1 cbranch-no" title="branch not covered" >80;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.endpoint) {
        options.endpoint = "/" + (options.apiVersion || "v1") + (options.apiNetwork ? ("/" + options.apiNetwork) : <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>;
    }
&nbsp;
...
var determineDataStorageV2_3 = function(options) {
    return q.when(options)
        .then(function(options) {
            // legacy
            <span class="missing-if-branch" title="if path not taken" >I</span>if (options.storePrimaryMnemonic) {
<span class="cstat-no" title="statement not covered" >                options.storeDataOnServer = options.storePrimaryMnemonic;</span>
            }
&nbsp;
            // storeDataOnServer=false when primarySeed is provided
            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof options.storeDataOnServer === "undefined") {
    ...
    return q.when(options)
        .then(function(options) {
            if (options.storeDataOnServer) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.secret) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.passphrase) {
<span class="cstat-no" title="statement not covered" >                        throw new blocktrail.WalletCreateError("Can't encrypt data without a passphrase");</span>
                    }
&nbsp;
...
APIClient.prototype.promisedEncrypt = function(pt, pw, iter) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (useWebWorker) {
        // generate randomness outside of webworker because many browsers don't have crypto.getRandomValues inside webworkers
        var saltBuf = <span class="cstat-no" title="statement not covered" >Encryption.generateSalt();</span>
        var iv = <span class="cstat-no" title="statement not covered" >Encryption.generateIV();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return webworkifier.workify(APIClient.prototype.promisedEncrypt, <span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
<span class="cstat-no" title="statement not covered" >            return require('./webworker');</span>
        }, {
            ...
            .then(<span class="fstat-no" title="function not covered" >fu</span>nction(data) {
<span class="cstat-no" title="statement not covered" >                return Buffer.from(data.cipherText.buffer);</span>
            });
    } else {
        try {
...
APIClient.prototype.promisedDecrypt = function(ct, pw) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (useWebWorker) {
<span class="cstat-no" title="statement not covered" >        return webworkifier.workify(APIClient.prototype.promisedDecrypt, <span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
<span class="cstat-no" title="statement not covered" >            return require('./webworker');</span>
        }, {
            ...
            .then(<span class="fstat-no" title="function not covered" >fu</span>nction(data) {
<span class="cstat-no" title="statement not covered" >                return Buffer.from(data.plainText.buffer);</span>
            });
    } else {
        try {
...
<span class="cstat-no" title="statement not covered" >                            if (!(options.secret instanceof Buffer)) {</span>
<span class="cstat-no" title="statement not covered" >                                throw new Error('Secret must be a buffer');</span>
                            }
                        }
                    })
                    .then(function() {
...
&nbsp;
                        notify(APIClient.CREATE_WALLET_PROGRESS_ENCRYPT_RECOVERY);
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.recoverySecret) {
...
&nbsp;
    var network = self.testnet ? bitcoin.networks.testnet : <span class="branch-1 cbranch-no" title="branch not covered" >bitcoin.networks.bitcoin;</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (useWebWorker) {
<span class="cstat-no" title="statement not covered" >        return webworkifier.workify(self.mnemonicToSeedHex, <span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
<span class="cstat-no" title="statement not covered" >            return require('./webworker');</span>
        }, {method: 'mnemonicToSeedHex', mnemonic: mnemonic, passphrase: passphrase})
            .then(<span class="fstat-no" title="function not covered" >fu</span>nction(data) {
<span class="cstat-no" title="statement not covered" >                return data.seed;</span>
            });
    } else {
        try {
...
&nbsp;
    try {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.passphrase &amp;&amp; options.password) {
<span class="cstat-no" title="statement not covered" >            throw new blocktrail.WalletCreateError("Can't specify passphrase and password");</span>
        }
...
&nbsp;
        // avoid conflicting options
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.primaryMnemonic &amp;&amp; options.primarySeed) {
<span class="cstat-no" title="statement not covered" >            throw new blocktrail.WalletInitError("Can only specify one of; Primary Mnemonic or Primary Seed");</span>
        }
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.primaryMnemonic &amp;&amp; !options.primarySeed) {
<span class="cstat-no" title="statement not covered" >            throw new blocktrail.WalletInitError("Need to specify at least one of; Primary Mnemonic or Primary Seed");</span>
        }
&nbsp;
        if (options.primarySeed) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.passphrase) {
<span class="cstat-no" title="statement not covered" >                throw new blocktrail.WalletInitError("Can't init wallet with Primary Mnemonic without a passphrase");</span>
            }
&nbsp;
...
&nbsp;
    try {
        // avoid conflicting options
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.backupMnemonic &amp;&amp; options.backupPublicKey) {
<span class="cstat-no" title="statement not covered" >            throw new blocktrail.WalletInitError("Can only specify one of; Backup Mnemonic or Backup PublicKey");</span>
        }
&nbsp;
        // make sure we have at least one thing to use
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.backupMnemonic &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!options.backupPublicKey)</span> {
<span class="cstat-no" title="statement not covered" >            throw new blocktrail.WalletInitError("Need to specify at least one of; Backup Mnemonic or Backup PublicKey");</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.backupPublicKey) {
<span class="cstat-no" title="statement not covered" >            if (options.backupPublicKey instanceof bitcoin.HDNode) {</span>
<span class="cstat-no" title="statement not covered" >                deferred.resolve(options);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                options.backupPublicKey = bitcoin.HDNode.fromBase58(options.backupPublicKey, network);</span>
<span class="cstat-no" title="statement not covered" >                deferred.resolve(options);</span>
            }
        } else {
...
&nbsp;
APIClient.prototype.debugAuth = <span class="fstat-no" title="function not covered" >fu</span>nction(cb) {
    var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return self.client.get("/debug/http-signature", null, true, cb);</span>
};
&nbsp;
/**
...
&nbsp;
APIClient.prototype.addresses = <span class="fstat-no" title="function not covered" >fu</span>nction(addresses, cb) {
    var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return self.client.post("/address", null, {"addresses": addresses}, cb);</span>
};
&nbsp;
/**
...
APIClient.prototype.addressTransactions = function(address, params, cb) {
    var self = this;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof params === "function") {
 ...
 * @return q.Promise
 */
APIClient.prototype.batchAddressHasTransactions = <span class="fstat-no" title="function not covered" >fu</span>nction(addresses, params, cb) {
    var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return self.client.post("/address/has-transactions", params, {"addresses": addresses}, cb);</span>
};
&nbsp;
/**
...
APIClient.prototype.getWebhookEvents = function(identifier, params, cb) {
    var self = this;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof params === "function") {
        cb = params;
        params = null;
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!identifier) {
<span class="cstat-no" title="statement not covered" >        deferred.reject(new blocktrail.WalletInitError("Identifier is required"));</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof keyIndex === "function") {
<span class="cstat-no" title="statement not covered" >            cb = keyIndex;</span>
<span class="cstat-no" title="statement not covered" >            keyIndex = null;</span>
        }
&nbsp;
        options = {
...
&nbsp;
        options.keyIndex = options.keyIndex || <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
        options.passphrase = options.passphrase || options.password;
        delete options.password;
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.identifier) {
<span class="cstat-no" title="statement not covered" >            deferred.reject(new blocktrail.WalletCreateError("Identifier is required"));</span>
<span class="cstat-no" title="statement not covered" >            return deferred.promise;</span>
        }
&nbsp;
        if (options.walletVersion === Wallet.WALLET_VERSION_V1) {
            ...
            self._createNewWalletV2(options)
                ...
                .then(function(r) { deferred.resolve(r); }, function(e) { deferred.reject(e); })
            ;
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (options.walletVersion === Wallet.WALLET_VERSION_V3) {
            self._createNewWalletV3(options)
                .progress(function(p) { deferred.notify(p); })
                .then(function(r) { deferred.resolve(r); }, function(e) { deferred.reject(e); })
            ;
        } else {
<span class="cstat-no" title="statement not covered" >            deferred.reject(new blocktrail.WalletCreateError("Invalid wallet version!"));</span>
        }
    });
&nbsp;
    return deferred.promise;
...
&nbsp;
        if (!options.primaryMnemonic &amp;&amp; !options.primarySeed) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.passphrase &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!options.password)</span> {
<span class="cstat-no" title="statement not covered" >                deferred.reject(new blocktrail.WalletCreateError("Can't generate Primary Mnemonic without a passphrase"));</span>
<span class="cstat-no" title="statement not covered" >                return deferred.promise;</span>
            } else {
                options.primaryMnemonic = bip39.generateMnemonic(Wallet.WALLET_ENTROPY_BITS);
                <span class="missing-if-branch" title="else path not taken" >E</span>if (options.storePrimaryMnemonic !== false) {
                    options.storePrimaryMnemonic = true;
                }
            }
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.backupMnemonic &amp;&amp; !options.backupPublicKey) {
...
&nbsp;
                    var wallet = new Wallet(
                        ...
                        null,
                        options.storeDataOnServer ? options.encryptedPrimarySeed : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
                        options.storeDataOnServer ? options.encryptedSecret : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >                                    null,</span>
                                backupSeed: options.backupSeed ? bip39.entropyToMnemonic(options.backupSeed.toString('hex')) : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
...
function verifyPublicBip32Key(bip32Key, network) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof hk.keyPair.d !== "undefined") {
<span class="cstat-no" title="statement not covered" >        throw new Error('BIP32Key contained private key material - abort');</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (bip32Key[1].slice(0, 1) !== "M") {
<span class="cstat-no" title="statement not covered" >        throw new Error("BIP32Key contained non-public path - abort");</span>
    }
}
&nbsp;
...
APIClient.prototype.deleteWallet = function(identifier, checksumAddress, checksumSignature, force, cb) {
    var self = this;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof force === "function") {
...
APIClient.prototype.coinSelection = function(identifier, pay, lockUTXO, allowZeroConf, feeStrategy, options, cb) {
    var self = this;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof feeStrategy === "function") {
<span class="cstat-no" title="statement not covered" >        cb = feeStrategy;</span>
<span class="cstat-no" title="statement not covered" >        feeStrategy = null;</span>
<span class="cstat-no" title="statement not covered" >        options = {};</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options === "function") {
<span class="cstat-no" title="statement not covered" >        cb = options;</span>
<span class="cstat-no" title="statement not covered" >        options = {};</span>
    }
&nbsp;
    feeStrategy = feeStrategy || <span class="branch-1 cbranch-no" title="branch not covered" >Wallet.FEE_STRATEGY_OPTIMAL;</span>
...
&nbsp;
    var params = {
        ...
        zeroconfself: (typeof options.allowZeroConfSelf !== "undefined" ? <span class="branch-0 cbranch-no" title="branch not covered" >options.allowZeroConfSelf </span>: true) ? 1 : <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
...
&nbsp;
    deferred.resolve(
        self.client.post("/wallet/" + identifier + "/coin-selection", params, pay).then(
            ...
            function(err) {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (err.message.match(/too low to pay the fee/)) {
<span class="cstat-no" title="statement not covered" >                    throw blocktrail.WalletFeeError(err);</span>
                }
&nbsp;
                throw err;
            }
 ...
 * @returns {q.Promise}
 */
APIClient.prototype.feePerKB = <span class="fstat-no" title="function not covered" >fu</span>nction(cb) {
    var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
    var deferred = <span class="cstat-no" title="statement not covered" >q.defer();</span>
<span class="cstat-no" title="statement not covered" >    deferred.promise.spreadNodeify(cb);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    deferred.resolve(self.client.get("/fee-per-kb"));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return deferred.promise;</span>
};
&nbsp;
...
APIClient.prototype.sendTransaction = function(identifier, txHex, paths, checkFee, twoFactorToken, prioboost, cb) {
    var self = this;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof twoFactorToken === "function") {
<span class="cstat-no" title="statement not covered" >        cb = twoFactorToken;</span>
<span class="cstat-no" title="statement not covered" >        twoFactorToken = null;</span>
<span class="cstat-no" title="statement not covered" >        prioboost = false;</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof prioboost === "function") {
<span class="cstat-no" title="statement not covered" >        cb = prioboost;</span>
<span class="cstat-no" title="statement not covered" >        prioboost = false;</span>
    }
&nbsp;
    var data = {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof txHex === "string") {
<span class="cstat-no" title="statement not covered" >        data.raw_transaction = txHex;</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof txHex === "object") {
...
&nbsp;
    return self.client.post(
        "/wallet/" + identifier + "/send",
        {
            ...
            prioboost: prioboost ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: 0
        },
        data,
        cb
    );
 ...
 * @return q.Promise
 */
APIClient.prototype.labelWalletAddress = <span class="fstat-no" title="function not covered" >fu</span>nction(identifier, address, label, cb) {
    var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return self.client.post("/wallet/" + identifier + "/address/" + address + "/label", null, {label: label}, cb);</span>
};
&nbsp;
APIClient.prototype.walletMaxSpendable = <span class="fstat-no" title="function not covered" >fu</span>nction(identifier, allowZeroConf, feeStrategy, options, cb) {
    var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof feeStrategy === "function") {</span>
<span class="cstat-no" title="statement not covered" >        cb = feeStrategy;</span>
<span class="cstat-no" title="statement not covered" >        feeStrategy = null;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    feeStrategy = feeStrategy || Wallet.FEE_STRATEGY_OPTIMAL;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (options.forcefee) {</span>
<span class="cstat-no" title="statement not covered" >        params['forcefee'] = options.forcefee;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return self.client.get("/wallet/" + identifier + "/max-spendable", params, true, cb);</span>
};
&nbsp;
/**
 ...
 * @param cb
 */
APIClient.prototype.faucetWithdrawl = <span class="fstat-no" title="function not covered" >fu</span>nction(address, amount, cb) {
    var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return self.client.post("/faucet/withdrawl", null, {address: address, amount: amount}, cb);</span>
};
&nbsp;
/**
