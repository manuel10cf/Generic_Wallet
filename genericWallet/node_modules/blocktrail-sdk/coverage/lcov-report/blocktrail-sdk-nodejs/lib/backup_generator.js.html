...
<html lang="en">
<head>
    <title>Code coverage report for blocktrail-sdk-nodejs/lib/backup_generator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">blocktrail-sdk-nodejs/lib/</a> backup_generator.js
    </h1>
    <div class='clearfix'>
...
var fs = require('fs');
&nbsp;
var qrCode = <span class="fstat-no" title="function not covered" >function(text, size, typeNumber, errorCorrectLevel) {</span>
<span class="cstat-no" title="statement not covered" >    var qr = qrcode(typeNumber || 4, errorCorrectLevel || 'L');</span>
<span class="cstat-no" title="statement not covered" >    qr.addData(text);</span>
<span class="cstat-no" title="statement not covered" >    qr.make();</span>
<span class="cstat-no" title="statement not covered" >    var base64 = qr.createImgBase64(size);</span>
<span class="cstat-no" title="statement not covered" >    var dataURL = 'data:image/gif;base64,' + base64;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return dataURL;</span>
};
&nbsp;
/**
 ...
 * @constructor
 */
var BackupGenerator = <span class="fstat-no" title="function not covered" >function(identifier, backupInfo, extraInfo, options) {</span>
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    backupInfo = backupInfo || {};</span>
<span class="cstat-no" title="statement not covered" >    extraInfo = extraInfo || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    self.identifier = identifier;</span>
<span class="cstat-no" title="statement not covered" >    self.backupInfo = backupInfo;</span>
<span class="cstat-no" title="statement not covered" >    self.extraInfo = extraInfo;</span>
<span class="cstat-no" title="statement not covered" >    self.options = _.merge({page1: true, page2: true, page3: true}, options);</span>
<span class="cstat-no" title="statement not covered" >    self.blocktrailPublicKeys = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (backupInfo.blocktrailPublicKeys) {</span>
<span class="cstat-no" title="statement not covered" >        _.each(backupInfo.blocktrailPublicKeys, <span class="fstat-no" title="function not covered" >function(pubKey, keyIndex) {</span></span>
<span class="cstat-no" title="statement not covered" >            self.blocktrailPublicKeys.push({</span>
                keyIndex: keyIndex,
                pubKey: pubKey,
                path: "M/" + keyIndex + "'",
 ...
 *
 */
BackupGenerator.prototype.generateHTML = <span class="fstat-no" title="function not covered" >function(cb) {</span>
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var data = {</span>
        ...
        extraInfo: _.map(self.extraInfo, <span class="fstat-no" title="function not covered" >function(value, key) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _.each(self.blocktrailPublicKeys, <span class="fstat-no" title="function not covered" >function(pubKey) {</span></span>
<span class="cstat-no" title="statement not covered" >        data.pubKeysHtml += "&lt;figure&gt;&lt;img src='" + pubKey.qr + "' /&gt;&lt;figcaption&gt;";</span>
<span class="cstat-no" title="statement not covered" >        data.pubKeysHtml += "&lt;span&gt;KeyIndex: " + pubKey.keyIndex + " &lt;/span&gt; ";</span>
<span class="cstat-no" title="statement not covered" >        data.pubKeysHtml += "&lt;span&gt;Path: " + pubKey.path + "&lt;/span&gt;";</span>
<span class="cstat-no" title="statement not covered" >        data.pubKeysHtml += "&lt;/figcaption&gt;&lt;/figure&gt;";</span>
    });
&nbsp;
    //load and compile the html
<span class="cstat-no" title="statement not covered" >    var compiledHtml;</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        compiledHtml =  _.template(fs.readFileSync(__dirname + "/resources/backup_info_template.html", {encoding: 'utf8'}));</span>
    } catch (e) {
<span class="cstat-no" title="statement not covered" >        return cb(e);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    cb(null, compiledHtml(data));</span>
};
&nbsp;
&nbsp;
/**
 ...
 *
 */
BackupGenerator.prototype.generateBackup = <span class="fstat-no" title="function not covered" >function(options, filename, callback) {</span>
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
<span class="cstat-no" title="statement not covered" >    self.generateHTML(<span class="fstat-no" title="function not covered" >function(err, html) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >            callback(err);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (typeof filename === 'undefined' || filename === null || filename === "") {</span>
<span class="cstat-no" title="statement not covered" >            htmlToFile.create(html, options).toBuffer(callback);</span>
        } else {
<span class="cstat-no" title="statement not covered" >            htmlToFile.create(html, options).toFile(filename, callback);</span>
        }
    });
};
&nbsp;
 ...
 */
BackupGenerator.prototype.generatePDF = <span class="fstat-no" title="function not covered" >function(filename, callback) {</span>
    /* jshint -W101 */
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.generateBackup(options, filename, callback);</span>
};
&nbsp;
