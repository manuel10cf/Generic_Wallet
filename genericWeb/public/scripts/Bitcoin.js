 ...
 */
function getAddressBTC(privateKey){
	var pvtKey = bigi.fromBuffer(privateKey)
	key_pair = new btcjs.ECPair(pvtKey, null,{network: btcjs.networks.testnet});
	document.getElementById('keyPair').value = "Private Key: " + pvtKey.toHex() + "\n" + "Address: " + key_pair.getAddress() 
}
/**
